...
class TransactionSpec extends ObjectBehavior
{
    ...
    function it_can_late_purchase(){
        $Transaction = new Transaction("AH2179-05", "5fb99hs6e8sb6wx3i5s1jxlt6l2q657b", "200780", "igJI8zxE4Cs~MyIbGEUBjjeL8WYoWw1h", true);
        $transarmor_token = $Transaction->PreAuth('Mastercard', 'Logan Henson', 5500000000000004, '1216', 120)['transarmor_token'];

        $this->beConstructedWith("AH2179-05", "5fb99hs6e8sb6wx3i5s1jxlt6l2q657b", "200780", "igJI8zxE4Cs~MyIbGEUBjjeL8WYoWw1h", true);
